...
def main():
    ...
    # Show progress
    sys.stdout.write('Avg Fill Time: {:.5f}s, '
                     'Avg Total Time: {:.5f}s, '.format(
    ...
    depth_image = cv2.imread('my_kitti_projections/0-1-1.png', cv2.IMREAD_ANYDEPTH)
    ...
    if save_depth_maps:
        depth_image_file_name = os.path.split('/demos')[1]
